...
- **SaaS**: URL, sign-up, supported browsers
- **Manual**: build from source, download binary

Provide a minimal working example or walkthrough.
...
- Screens and modules (apps)
- Endpoints and operations (services)
- Workflows and scenarios (any type)

Cover the most common user tasks with concrete examples.
