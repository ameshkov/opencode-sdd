...
- Perform heavy work (indexing, compilation, downloads) on background threads;
...
- Handle crashes gracefully — write crash logs, offer to restore previous state
  on next launch, do not corrupt user data.
