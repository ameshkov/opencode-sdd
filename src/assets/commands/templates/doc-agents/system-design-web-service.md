...
- Provide CLI commands for periodic jobs.
  In production periodic jobs will be scheduled using K8s CronJobs.
  Exception: use an in-process scheduler only for very frequent
  (seconds/minutes) and lightweight tasks.
