...
Scenario: Interruption and resume
  ...
  When I start /prd-auto-implement and Ctrl-C after plan.md exists but before completion
...
Scenario: HITL question pauses the run
  ...
  Then the orchestration stops at the gate before planning, shows the question in the TUI, and resumes after the answer
